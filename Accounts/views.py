...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            # messages.success(request, 'Thank you for registering with us, we have send you verification email to your email address [rakeshmuthineni9@gmail.com], please varify it')
